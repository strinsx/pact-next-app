...
export default function Onboarding() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      ...
      <p className="mt-2 font-manrope text-sm font-semibold text-muted">
      ...
      <div className="mt-8 flex w-full max-w-sm flex-col gap-5 rounded-2xl border-1 border-border bg-surface p-8">
        <div className="flex items-center gap-3">
          ...
          <span className="font-dm-sans text-xs font-semibold uppercase tracking-wide text-muted/50">
        ...
        <button
          ...
          disabled={loading}
          className="w-full cursor-pointer rounded-xl border-1 border-border bg-surface py-1 font-dm-sans font-bold text-md text-primary shadow-sm disabled:cursor-not-allowed disabled:opacity-60"
        >
