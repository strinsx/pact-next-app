                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {canKick && (
                      <button
                        ...
                        className="flex cursor-pointer items-center gap-1 rounded-lg border-1 border-border bg-surface px-2 py-1 font-nunito text-xs font-bold text-red-500 transition-colors hover:bg-red-500/10"
                      >
          ...
          >
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                ...
                onClick={handleKick}
                disabled={kicking}
                className="flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-lg bg-red-500 py-2 font-nunito font-bold text-white transition-colors hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-60"
              >
