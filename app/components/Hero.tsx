        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="flex flex-col gap-6">
              <h1 className="font-manrope text-5xl font-extrabold leading-[1.1] text-primary lg:text-6xl">
                Say it. Show up.{" "}
              ...
              <p className="max-w-lg font-dm-sans text-lg leading-relaxed text-muted">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link
                  ...
                  className="rounded-full bg-gradient-to-r from-sky-400 to-purple px-7 py-3 font-dm-sans text-sm font-bold text-white transition-all delay-300 duration-300 hover:translate-x-[8px] hover:opacity-90"
                >
                  Start your pact
                </Link>
                <Link
                  href="#how-it-works"
                  className="flex items-center gap-2 rounded-lg border-1 border-border bg-surface px-7 py-3 font-dm-sans text-sm font-bold text-primary transition-colors hover:border-primary hover:bg-primary hover:text-white"
                >
