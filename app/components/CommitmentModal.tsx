...
import { createCommitment } from "@/app/lib/services/commitments";
...
export default function CommitmentModal({ open, type, evaluationTime, onClose, onCreated }: CommitmentModalProps) {
