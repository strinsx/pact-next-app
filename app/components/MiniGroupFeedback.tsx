...
export default function MiniGroupFeedback() {
  return (
    <div className="w-full max-w-md justify-self-center rounded-[20px] border-1 border-border bg-surface p-6 shadow-xl animate-[float_4s_ease-in-out_infinite] lg:justify-self-end">
      ...
      <p className="mt-1 font-nunito text-xs text-muted">Live from your group</p>
        ...
        {miniPosts.map((post) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-sky-400 to-purple font-nunito text-xs font-bold text-white">
              ...
              <span className="rounded-full bg-border/50 px-2.5 py-1 font-nunito text-xs font-bold text-primary">
                {post.reaction}
              </span>
            </div>
