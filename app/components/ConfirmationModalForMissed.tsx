...
interface ConfirmationModalForMissedProps {
  open: boolean;
  title: string;
  onClose: () => void;
  onConfirm: () => void;
  ...
  return (
    ...
    >
      <svg width="0" height="0" className="absolute">
        <defs>
          <linearGradient id="missedCommitGrad" x1="0" y1="0" x2="1" y2="0">
      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-2 text-left">
          ...
          <p className="font-nunito text-sm text-muted">
            Are you sure you want to commit, this commitment is in{" "}
